...
type McpServerStatus = { name: string; toolCount: number; toolNames: string[]; ok: boolean; error?: string };
let mcpStatus: McpServerStatus[] = [];
export function getMcpStatus(): McpServerStatus[] { return mcpStatus; }
